# ======================== EXP_7_IAFF_MESCA_GMN ARCHITECTURE ==========================
#
#               ┌──────────────┐     ┌──────────────┐
#               │   Input RDI  │     │   Input RAI  │
#               │ (T,H,W, C=4) │     │ (T,H,W, C=1) │
...
np.save('exp_7_IAFF_MESCA_GMN_history.npy', history.history)

# Save only the architecture
model_json = model.to_json()
with open("exp_7_IAFF_MESCA_GMN_architecture.json", "w") as json_file:
    json_file.write(model_json)

# Save only the weights
model.save_weights("exp_7_IAFF_MESCA_GMN_weights.h5")
